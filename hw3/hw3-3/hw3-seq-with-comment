...
void block_FW(int B) {
    ...
    for (int r = 0; r < round; ++r) {
        ...
        // cal (block size, round, startx, starty, width, height)
        ...
        // calculate upper left remaining block
        cal(B, r, 0, 0, r, r);
        // calculate upper right remaining block
        cal(B, r, 0, r + 1, round - r - 1, r);
        // calculate down left remaining block
        cal(B, r, r + 1, 0, r, round - r - 1);
        // calculate down right remaining block
